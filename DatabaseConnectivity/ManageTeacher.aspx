<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageTeacher.aspx.cs" Inherits="DatabaseConnectivity.ManageTeacher" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="mt-4 p-5 bg-primary text-white rounded">
            ...
            <p>You can add, update and delete Teacher record from this page...</p>
        </div>
        <div>
            ...
            <table class="w-100 table table-hover table-bordered">
                <tr>
                    <td rowspan="9">
                        <asp:ListBox AutoPostBack="true" CssClass="form-select form-select-lg" ID="TeacherNamesList" runat="server" OnSelectedIndexChanged="TeacherNamesList_SelectedIndexChanged"></asp:ListBox>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Button ID="btnDeleteTeacher" CssClass="btn btn-danger btn-block" runat="server" Text="Delete Teacher" OnClick="btnDeleteTeacher_Click" /></td>
                    <td>&nbsp;</td>
                    <td>
                        <div class="d-grid">
                            <asp:Button ID="btnUpdateTeacher" Visible="false" CssClass="btn btn-success btn-block" runat="server" Text="Update Teacher" OnClick="btnUpdateTeacher_Click" />
                            <asp:Button ID="btnAddTeacher" CssClass="btn bg-dark btn-block" ForeColor="White" runat="server" Text="Save New Teacher" OnClick="btnAddTeacher_Click" />
                        </div>
                    </td>
                </tr>
                <tr>
