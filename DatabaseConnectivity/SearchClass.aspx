<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchClass.aspx.cs" Inherits="DatabaseConnectivity.SearchClass" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="mt-4 p-5 bg-primary text-white rounded">
            <h1>Search Class Page</h1>
            <p>You can search Class record from this page...</p>
        </div>
        <hr />
        ...
        <div>
            <table class="w-100 table table-hover table-bordered">
                <tr>
                    ...
                    <td>
                        <asp:Label ID="Label5" runat="server" Text="&nbsp;Please Enter Class Contact No"></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td colspan="4">
                        <div class="d-grid">
                            <asp:Button ID="btnSearchClass" CssClass="btn bg-dark btn-block" ForeColor="White" runat="server" Text="Search Class" OnClick="btnSearchClass_Click" />
                        </div>
                    </td>
                </tr>
                <tr>
