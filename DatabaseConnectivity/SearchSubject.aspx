<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchSubject.aspx.cs" Inherits="DatabaseConnectivity.SearchSubject" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="mt-4 p-5 bg-primary text-white rounded">
            <h1>Search Subject Page</h1>
            <p>You can Search Subject record from this page...</p>
        </div>
        <div>
            ...
            <table class="w-100 table table-hover table-bordered">
                ...
                <tr>
                    <td colspan="4">
                        <div class="d-grid">
                            <asp:Button ID="btnSearchStudent" CssClass="btn bg-dark btn-block" ForeColor="White" runat="server" Text="Search Subject" OnClick="btnSearchSubject_Click" />
                        </div>
                    </td>
                </tr>
                <tr>
